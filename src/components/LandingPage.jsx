    ...
    <div className="min-h-[calc(100vh-64px)] lg:px-14 sm:px-8 px-4">
        <div className="lg:flex-row flex-col lg:py-5 pt-15 lg:gap-10 gap-8 flex justify-between items-center">
            <div className="flex-1">
                ...
                className="font-bold font-roboto text-slate-800 md:text-5xl sm:text-3xl md:leading-[55px] sm:leading-[45px] leading-10 lg:w-full md:w-[70%] w-full">
                ...
                <div className="flex items-center gap-3">
                    ...
                    transition={{duration: 0.8}}
                    onClick={dashBoardNavigateHandler}
                    className="color-btn border-blue-500 border-width:5px border text-blue-500 w-40 rounded-md py-2">
                        Create Short URL
                    </motion.button>
                </div>
            </div>
